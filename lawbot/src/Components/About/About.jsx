        ...
        <section className={classes.aboutSection}>
            ...
            <div className={classes.cardContainer}>
                <div className={classes.card}>
                    ...
                    <button onClick={() => window.location.href = "/"} className={classes.button}>Mission</button>
                </div>
            <div className={classes.card}>
            <img src={warning} alt="Vision" className={classes.cardIcon} />
                ...
                <button onClick={() => window.location.href = "/"} className={classes.button}>Limitation</button>
            </div>
            <div className={classes.card}>
                <img src={diamond} alt="Values" className={classes.cardIcon} />
                    ...
                    <button onClick={() => window.location.href = "/"} className={classes.button}>Feedback</button>
                </div>
            </div>
        </section>
        <Footer />
